"""
Script from : https://github.com/generalroboticslab/ClutterGen/blob/main/pybullet_utils_cust.py
"""
...
def set_joint_position(body, joint, value, client_id=0):
    p.resetJointState(body, joint, value, physicsClientId=client_id) # body, joint, targetValue , targetVelocity (optional)
